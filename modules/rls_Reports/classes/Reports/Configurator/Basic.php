...
class Basic
{
    ...
    public function getDisplayLink($module = '', $field = '', $relations = '')
    {
        ...
        $link = $app_list_strings['moduleList'][$module] . ' > ';
        if ($relations) {
    ...
    public function getRelationLabel($parentModuleName, $relationName)
    {
        ...
        if (isset($parent_module->$relationName) ) {
            ...
            if (isset($app_list_strings['moduleList'][$child_module])
                ...
                if (isset($parentModuleName) and isset($properties['vname'])
                    and translate($properties['vname'], $parentModuleName) != $properties['vname']
                ) {
                    $label = translate($properties['vname'], $parentModuleName);
                } else {

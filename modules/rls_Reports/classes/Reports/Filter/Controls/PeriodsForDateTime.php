...
/**
 * This class is intended for handling Control of PeriodsForDateTime type
 * 
 * FIXME: This control should be retrieved by stnadard agregates of Sugar
 * 
 * @package Reports.Filter.Controls
 * */
class PeriodsForDateTime extends Dropdown
{
    ...
    public function getHtml($current_value = null)
    {
        ...
        $html = '';
        ob_start();
            require(dirname(__FILE__).'/../tpls/PeriodsForDateTime.php');

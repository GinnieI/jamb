<?php /* Smarty version 2.6.33, created on 2022-10-24 11:16:06
...
<script type="text/javascript">
	...
	SUGAR.util.doWhen(
		...
		function(){
			...
			<?php $_from = $this->_tpl_vars['css']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
